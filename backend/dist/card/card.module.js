...
exports.CardModule = CardModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([card_entity_1.Task, column_entity_1.KanbanColumn])],
        controllers: [card_controller_1.TaskController],
        providers: [card_service_1.TaskService],
    })
], CardModule);
